...
{
    int j,k;      unsigned *d = md5(msg, strlen(msg));
...
Read original Article: C program of MD5 Encryption Algorithm | C codechamp | Learn C Programming | C Language | C programs 